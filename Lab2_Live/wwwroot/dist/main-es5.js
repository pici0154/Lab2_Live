...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFlowerDetailsFlowerDetailsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _flower_details_flower_details_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./flower-details/flower-details.component */
    ...
    AppModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"].withServerTransition({
        ...
        component: _flower_details_flower_details_component__WEBPACK_IMPORTED_MODULE_10__["FlowerDetailsComponent"]
      }, {
        path: 'my-route',
        component: _counter_counter_component__WEBPACK_IMPORTED_MODULE_8__["CounterComponent"]
      }])],
    ...
    var FetchDataComponent = /*#__PURE__*/function () {
      ...
      _createClass(FetchDataComponent, [{
        ...
        value: function loadFlowers() {
          ...
          this.http.get(this.baseUrl + 'api/Flowers').subscribe(function (result) {
            _this.flowers = result;
            console.log(_this.flowers);
          }, function (error) {
        ...
        key: "delete",
        value: function _delete(flowerId) {
          var _this2 = this;

          if (confirm('Are you sure you want to delete the flower with id ' + flowerId + '?')) {
            this.http["delete"](this.baseUrl + 'api/Flowers/' + flowerId).subscribe(function (result) {
              alert('Flower successfully deleted!');

              _this2.loadFlowers();
            }, function (error) {
              return alert('Cannot delete flower - maybe it has comments?');
            });
          }
        }
      }, {
        ...
        value: function submit() {
          ...
          this.http.post(this.baseUrl + 'api/Flowers', flower).subscribe(function (result) {
            console.log('success!');
  ...
  /***/
  function srcAppFlowerDetailsFlowerDetailsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFlowerDetailsFlowerDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FlowerDetailsComponent", function () {
      return FlowerDetailsComponent;
    });
    /* harmony import */
    ...
    var FlowerDetailsComponent = /*#__PURE__*/function () {
      function FlowerDetailsComponent(http, baseUrl, route) {
        _classCallCheck(this, FlowerDetailsComponent);
      ...
      _createClass(FlowerDetailsComponent, [{
        key: "loadFlower",
        value: function loadFlower(flowerId) {
          var _this4 = this;

          this.http.get(this.baseUrl + 'api/Flowers/' + flowerId).subscribe(function (result) {
            _this4.flower = result;
            console.log(_this4.flower);
          }, function (error) {
            return console.error(error);
          });
        }
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            _this5.loadFlower(params.get('flowerId'));
          });
        }
      }]);
    ...
    FlowerDetailsComponent.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]
      }, {
        type: String,
    ...
    FlowerDetailsComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      selector: 'app-flower-details',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./flower-details.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/flower-details/flower-details.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./flower-details.component.css */
      "./src/app/flower-details/flower-details.component.css"))["default"]]
    }), __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])('BASE_URL')), __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], String, _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])], FlowerDetailsComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Roxana\source\repos\Lab2_Live\Lab2_Live\ClientApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
